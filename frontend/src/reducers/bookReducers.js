...
export const bookCategoryReducer = (state = { books: [] }, action) => {
  switch (action.type) {
    case BOOK_CATEGORY_REQUEST:
      return { loading: true, books: [] }
    case BOOK_CATEGORY_SUCCESS:
      return {
        loading: false,
        books: action.payload.books,
        pages: action.payload.pages,
